...
INSERT INTO tblbooknumber (ID, BOOKTITLE, QTY, Descr, Author, PublishDate, Publisher) VALUES
...
INSERT INTO tblpayment (PaymentId, BorrowId, Payment, Changer, DatePayed, BorrowerId, Remarks) VALUES
...
(3, 'Jen Paris', 'admin', 'admin', 'Librarian', 'Active'),
(4, 'Craig Smith', 'librarian', 'librarian', 'Librarian', 'NotActive'),
(5, 'Tommy Chen', 'tchen', 'tchen', 'Librarian', 'NotActive'),
(6, 'Mary Martins', 'mmartins', 'mmartins', 'Administrator', 'NotActive'),
(7, 'Jason Williams', 'jwilliams', 'jwilliams', 'Librarian', 'NotActive'),
(8, 'Suzana Winners', 'swinners', 'swinners', 'Librarian', 'Active'),
(9, 'Owen Simpson', 'osimpson', 'osimpson', 'Assistant', 'Active'),
(10, 'Sury Timmins', 'stimmins', 'stimmins', 'Assistant', 'NotActive');
